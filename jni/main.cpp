...
private:
    ...
    // Simple 8x8 font data (ASCII 32-126)
...
const unsigned char FontRenderer::font_data[128][8] = {
    ...
    {0x7E,0xC6,0xCE,0xD6,0xE6,0xC6,0x7E,0x00},
    {0x18,0x38,0x18,0x18,0x18,0x18,0x7E,0x00},
    {0x7E,0xC6,0x0C,0x18,0x30,0x60,0xFE,0x00},
    {0x7E,0xC6,0x0C,0x38,0x0C,0xC6,0x7E,0x00},
    {0x0C,0x1C,0x3C,0x6C,0xCC,0xFE,0x0C,0x00},
    {0xFE,0xC0,0xFC,0x06,0x06,0xC6,0x7E,0x00},
    {0x3C,0x60,0xC0,0xFC,0xC6,0xC6,0x7C,0x00},
    {0xFE,0x06,0x0C,0x18,0x30,0x30,0x30,0x00},
    {0x7C,0xC6,0xC6,0x7C,0xC6,0xC6,0x7C,0x00},
    {0x7C,0xC6,0xC6,0x7E,0x06,0x0C,0x78,0x00},
    // ... остальные символы (заполняем нулями для простоты)
};
